    ...
    <div class="row">
        <div class="col-sm-6 col-sm-offset-3 text-center registration">
            <form ng-submit="submit('{{ csrf_token() }}')">
                ...
                <p ng-show="reloading">Reloading reCAPTCHA..</p>
                <div class="fluid" ng-hide="reloading" vc-recaptcha key="'6LczwwcTAAAAAG7nlVweJHYX0jzL_ZJJTui_Zips'" on-create="captchaLoading = false" on-success="captcha(response)"></div>
